	...
	<div class="whm-admin-layout">
		...
		<div class="whm-main-column">
				...
				<div class="whm-header-content">
					<div class="whm-header-info">
						<div class="whm-logo-group">
							...
							<h2 class="whm-logo-title"><?php esc_html_e( 'Hook Manager', 'hookpilot-for-woocommerce' ); ?></h2>
							<span class="whm-version-badge">v<?php echo esc_html( WHM_VERSION ); ?></span>
						</div>
						<p class="whm-header-tagline"><?php esc_html_e( 'Visually manage WooCommerce hooks without editing any files.', 'hookpilot-for-woocommerce' ); ?></p>
					</div>
			...
			<nav class="whm-nav-tabs">
				<?php
				$tabs = array(
					'dashboard'  => array( 'label' => __( 'Dashboard', 'hookpilot-for-woocommerce' ), 'slug' => 'whm-dashboard', 'icon' => 'dashboard' ),
					'inspector'  => array( 'label' => __( 'Hook Inspector', 'hookpilot-for-woocommerce' ), 'slug' => 'whm-inspector', 'icon' => 'search' ),
					'manager'    => array( 'label' => __( 'Hook Manager', 'hookpilot-for-woocommerce' ), 'slug' => 'whm-manager', 'icon' => 'sort' ),
					'add_hook'   => array( 'label' => __( '+ Add Rule', 'hookpilot-for-woocommerce' ), 'slug' => 'whm-add-hook', 'icon' => 'edit' ),
					'import_export' => array( 'label' => __( 'Import/Export', 'hookpilot-for-woocommerce' ), 'slug' => 'whm-import-export', 'icon' => 'migrate' ),
				);
					...
					<div class="whm-dashboard">
						<div class="whm-welcome-box">
							<div class="whm-welcome-text">
								...
								<div class="whm-welcome-actions">
									<a href="<?php echo esc_url( admin_url( 'admin.php?page=whm-inspector' ) ); ?>" class="whm-btn whm-btn--primary"><?php esc_html_e( 'Get Started', 'hookpilot-for-woocommerce' ); ?></a>
								</div>
							</div>
						...
						<div class="whm-cards">
							<div class="whm-card">
								...
								<a href="<?php echo esc_url( admin_url( 'admin.php?page=whm-inspector' ) ); ?>" class="whm-btn whm-btn--outline whm-btn--full"><?php esc_html_e( 'Inspect Hooks', 'hookpilot-for-woocommerce' ); ?></a>
							</div>
							<div class="whm-card">
								...
								<a href="<?php echo esc_url( admin_url( 'admin.php?page=whm-manager' ) ); ?>" class="whm-btn whm-btn--outline whm-btn--full"><?php esc_html_e( 'Manage Rules', 'hookpilot-for-woocommerce' ); ?></a>
							</div>
							<div class="whm-card">
								...
								<a href="<?php echo esc_url( admin_url( 'admin.php?page=whm-add-hook' ) ); ?>" class="whm-btn whm-btn--outline whm-btn--full"><?php esc_html_e( 'Create Rule', 'hookpilot-for-woocommerce' ); ?></a>
							</div>
						</div>
					</div>
				...
				elseif ( 'inspector' === $view ) : ?>
					<div class="whm-inspector">
						...
						<div class="whm-toolbar">
							<input type="text" id="whm-inspector-search" class="whm-input" placeholder="<?php esc_attr_e( 'Filter by hook name…', 'hookpilot-for-woocommerce' ); ?>" />
							<button id="whm-load-inspector" class="whm-btn whm-btn--primary"><?php esc_html_e( 'Load Hooks', 'hookpilot-for-woocommerce' ); ?></button>
						</div>

						<div id="whm-inspector-table-wrap">
							<p class="whm-placeholder"><?php esc_html_e( 'Click "Load Hooks" to inspect registered callbacks.', 'hookpilot-for-woocommerce' ); ?></p>
						</div>
					</div>
						...
						<div class="whm-rules-container">
							...
							<?php if ( empty( $settings ) ) : ?>
								<div class="whm-empty-state" style="padding: 60px;">
									...
									<a href="<?php echo esc_url( admin_url( 'admin.php?page=whm-add-hook' ) ); ?>" class="whm-btn whm-btn--primary"><?php esc_html_e( '+ Add Rule', 'hookpilot-for-woocommerce' ); ?></a>
								</div>
							<?php else : ?>
									...
									?>
										<div class="whm-rule-card" data-id="<?php echo (int) $index; ?>">
											...
											<div class="whm-rule-actions-cell">
												<button class="whm-btn whm-btn--sm whm-btn--outline whm-btn-edit" data-id="<?php echo (int) $index; ?>" title="<?php esc_attr_e( 'Edit', 'hookpilot-for-woocommerce' ); ?>">
													<span class="dashicons dashicons-edit"></span>
												</button>
												<button class="whm-btn whm-btn--sm whm-btn--danger whm-btn-delete" data-id="<?php echo (int) $index; ?>" title="<?php esc_attr_e( 'Delete', 'hookpilot-for-woocommerce' ); ?>">
					...
					<div id="whm-edit-modal" class="whm-modal" style="display:none;" aria-modal="true" role="dialog">
						...
						<div class="whm-modal__box">
							...
							<div class="whm-modal__body">
								<form id="whm-edit-form" class="whm-form whm-form--modal">
									...
									<div class="whm-edit-section whm-section-box" id="edit-section-callback">
										<p class="whm-section-box__head"><?php esc_html_e( 'Callback', 'hookpilot-for-woocommerce' ); ?></p>
										<div class="whm-form-row" style="margin-bottom:0">
											...
											<p class="whm-field-hint"><?php esc_html_e( 'Enter the exact callback name to disable or re-prioritise.', 'hookpilot-for-woocommerce' ); ?></p>
										</div>
									</div>

									<!-- Priority section -->
									<div class="whm-edit-section whm-section-box" id="edit-section-priority" style="display:none">
										<p class="whm-section-box__head"><?php esc_html_e( 'Priority Settings', 'hookpilot-for-woocommerce' ); ?></p>
									...
									<div class="whm-edit-section whm-section-box" id="edit-section-wrapper" style="display:none">
										<p class="whm-section-box__head"><?php esc_html_e( 'HTML Wrapper', 'hookpilot-for-woocommerce' ); ?></p>
										<div class="whm-form-row">
									...
									<div class="whm-edit-section whm-section-box" id="edit-section-content" style="display:none">
										<p class="whm-section-box__head"><?php esc_html_e( 'Custom Content', 'hookpilot-for-woocommerce' ); ?></p>
										<textarea id="whm-edit-content" name="setting[custom_content]" class="whm-textarea" rows="7" placeholder="<?php esc_attr_e( 'Enter custom HTML...', 'hookpilot-for-woocommerce' ); ?>"></textarea>
										<p class="whm-field-hint"><?php esc_html_e( 'Full WYSIWYG is available on the Add Rule page. HTML is preserved here.', 'hookpilot-for-woocommerce' ); ?></p>
									...
									<div class="whm-edit-section whm-section-box" id="edit-section-shortcode" style="display:none">
										<p class="whm-section-box__head"><?php esc_html_e( 'Shortcode', 'hookpilot-for-woocommerce' ); ?></p>
										<div class="whm-form-row">
							...
							<div class="whm-modal__foot">
								<button type="button" class="whm-modal__close whm-btn whm-btn--outline"><?php esc_html_e( 'Cancel', 'hookpilot-for-woocommerce' ); ?></button>
				...
				elseif ( 'add_hook' === $view ) : ?>
					<div class="whm-add-hook">
						...
						<form id="whm-add-hook-form" class="whm-form">
							...
							<div class="whm-form-row">
								<label><?php esc_html_e( 'Rule Label', 'hookpilot-for-woocommerce' ); ?> <span class="whm-text-muted" style="font-weight: 400; font-size: 12px;"><?php esc_html_e( '(Internal name for your reference)', 'hookpilot-for-woocommerce' ); ?></span></label>
								<input type="text" name="setting[rule_title]" class="whm-input" placeholder="<?php esc_attr_e( 'e.g., Custom Upsell Banner', 'hookpilot-for-woocommerce' ); ?>" />
							</div>
							...
							<div class="whm-rule-section whm-section-box" id="section-callback">
								<h3 class="whm-section-box__head"><?php esc_html_e( 'Select Callback to Disable', 'hookpilot-for-woocommerce' ); ?></h3>
								<div class="whm-form-row" style="margin-bottom:0">
									...
									<p class="whm-field-hint"><?php esc_html_e( 'Callbacks load automatically when you select a hook.', 'hookpilot-for-woocommerce' ); ?></p>
								</div>
							</div>

							<!-- CHANGE PRIORITY -->
							<div class="whm-rule-section whm-section-box" id="section-priority" style="display:none">
								<h3 class="whm-section-box__head"><?php esc_html_e( 'Change Priority', 'hookpilot-for-woocommerce' ); ?></h3>
								<div class="whm-form-row">
								...
								<div class="whm-priority-grid">
									<div class="whm-form-row" style="margin-bottom:0">
										...
										<p class="whm-field-hint"><?php esc_html_e( 'Auto-filled when callback is picked', 'hookpilot-for-woocommerce' ); ?></p>
									</div>
									<div class="whm-form-row" style="margin-bottom:0">
										<label><?php esc_html_e( 'New Priority', 'hookpilot-for-woocommerce' ); ?></label>
							...
							<div class="whm-rule-section whm-section-box" id="section-wrapper" style="display:none">
								<h3 class="whm-section-box__head"><?php esc_html_e( 'HTML Wrapper', 'hookpilot-for-woocommerce' ); ?></h3>
								<div class="whm-form-row">
									<label><?php esc_html_e( 'HTML Tag', 'hookpilot-for-woocommerce' ); ?></label>
									<div class="whm-tag-picker">
										<?php foreach ( array( 'div','span','section','article','aside','header','footer','p','nav' ) as $tag ) : ?>
							...
							<div class="whm-rule-section whm-section-box" id="section-content" style="display:none">
								<h3 class="whm-section-box__head"><?php esc_html_e( 'Custom Content (WYSIWYG)', 'hookpilot-for-woocommerce' ); ?></h3>
							...
							<div class="whm-rule-section whm-section-box" id="section-shortcode" style="display:none">
								<h3 class="whm-section-box__head"><?php esc_html_e( 'Shortcode', 'hookpilot-for-woocommerce' ); ?></h3>
								<div class="whm-form-row">
									<label><?php esc_html_e( 'Shortcode', 'hookpilot-for-woocommerce' ); ?></label>
